<div class="container columns is-fluid mt-2">
...
<div class="containerUpdate">
	<div class="container px-4 pb-6">
		<?php
			$datos=$insLogin->selectData("Unico","usuario","usuario_id",$id);
		...
		<p class="has-text-centered pb-6"><?php echo "<strong class='resaltado'>Usuario creado:</strong> ".date("d-m-Y  h:i:s A",strtotime($datos['usuario_creado']))." &nbsp; <strong class='resaltado'>Usuario actualizado:</strong> ".date("d-m-Y  h:i:s A",strtotime($datos['usuario_actualizado'])); ?></p>
